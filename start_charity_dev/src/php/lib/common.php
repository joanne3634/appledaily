...
$QUESTIONAIRE_DATASET = array(
	...
	"education"=>array('國小','國中','高中','高職','專科','大學','碩士','博士','其他'),
	...
	"careerUsed"=>array('無工作經驗','經營／人資類','行銷／企劃／專案管理類','餐飲／旅遊／美容美髮類','操作／技術／維修類','營建／製圖類','文字／傳媒工作類','學術／教育／輔導類','生產製造／品管／環衛類','財會／金融專業類','行政／總務／法務類','客服／門市／業務／貿易類','資訊軟體系統類','資材／物流／運輸類','傳播藝術／設計類','醫療／保健服務類','研發相關類','軍警消／保全類','農林漁牧相關類','其他職類'),
	"income"=>array('無固定收入','20萬以下', '20-50萬', '50-100萬', '100-150萬', '150-200萬', '200萬以上'),
	"charityHistory"=>array('沒有印象','平均每個月數次','平均每個月一次','平均每二個月一次','平均每半年一次','平均每年一次'),
	...
	"charityActivity"=>array('無','捐贈發票','捐贈物資','捐血／捐骨髓','購買公益彩卷','環保／社區發展','身心障礙者服務','老人服務','兒童服務','動物保護','公益健走／路跑','課業輔導','參與其他類型的志工活動')
);
