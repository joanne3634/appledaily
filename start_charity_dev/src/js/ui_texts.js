...
var QUESTIONAIRE_FORM_TEXTS = {
	...
	'careerTitle': '目前就職狀態',
	'careerOpts': GET_SELECT_OPTS(['在職','待業','學生','家管','退休']),
	'incomeTitle': '年收入區間',
	...
	'charityTendencyOpts': GET_SELECT_OPTS(['捐款至對您有意義或對您在乎的人有幫助或您曾受過幫助的非營利組織，例如您所就讀的母校。', '捐款至普遍大型的非營利組織，由於該組織的活動為多數人所認同，且您也容易進行捐款，例如聯合勸募。', '捐款至富理想性的非營利組織，由於您認為他們做的事是最為重要的，例如國際特赦組織。', '捐款至與您的宗教信仰符合的非營利組織，例如教會與寺廟。', '捐款至當地的非營利組織，通常您的捐款對他們而言是一筆不小的幫助，這會讓您確切感受到您的付出。', '捐款至您所熟識的人建立的非營利組織，因個人因素而讓您想幫助他(她)所建立的組織。']),
