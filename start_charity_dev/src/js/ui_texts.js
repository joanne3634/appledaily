...
var QUESTIONAIRE_FORM_TEXTS = {
	...
	'educationTitle': '學歷',
	'educationOpts': GET_SELECT_OPTS(['國小', '國中', '高中', '高職', '專科', '大學', '碩士', '博士', '其他']),
	'marriageTitle': '婚姻狀況',
	'marriageOpts': GET_SELECT_OPTS(['未婚', '已婚無子女', '已婚有子女', '離婚／失婚無子女', '離婚／失婚有子女', '其他']),
	'religionTitle': '宗教信仰',
	'religionOpts': GET_SELECT_OPTS(['無', '佛教／道教', '基督教', '天主教', '伊斯蘭教', '一貫道', '其他']),
	'careerUsedTitle': '從事（曾從事）行業類別（可複選）',
	'careerUsedOpts': GET_SELECT_OPTS(['無工作經驗','經營／人資類', '行銷／企劃／專案管理類', '餐飲／旅遊／美容美髮類', '操作／技術／維修類', '營建／製圖類', '文字／傳媒工作類', '學術／教育／輔導類', '生產製造／品管／環衛類', '財會／金融專業類', '行政／總務／法務類', '客服／門市／業務／貿易類', '資訊軟體系統類', '資材／物流／運輸類', '傳播藝術／設計類', '醫療／保健服務類', '研發相關類', '軍警消／保全類', '農林漁牧相關類', '其他職類']),
	'careerTitle': '目前就職狀態',
	'careerOpts': GET_SELECT_OPTS(['在職 (包含 SOHO, 接案)','待業','學生','家管','退休']),
	'incomeTitle': '年收入區間',
	'incomeOpts': GET_SELECT_OPTS(['無固定收入','20 萬以下', '20 - 50 萬', '50 - 100 萬', '100 - 150 萬', '150 - 200 萬', '200 萬以上']),
	...
	'charityActivityOpts': GET_SELECT_OPTS(['無','捐贈發票', '捐贈物資', '捐血／捐骨髓', '購買公益彩卷', '環保／社區發展', '身心障礙者服務', '老人服務', '兒童服務', '動物保護', '公益健走／路跑', '課業輔導', '參與其他類型的志工活動']),
	'charityWillingTitle': '請問您樂意在社群網站 (例如 Facebook 或 LINE) 分享公益募款文章給朋友嗎?',
	'charityTendencyOtherTitle' : '其他捐款意向',
	'charityJobTitle': '職稱 (選填)'
};