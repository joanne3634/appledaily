...
var QUESTIONAIRE_FORM_TEXTS = {
	'genderTitle': '性別',
	'genderOpts': GET_RADIO_OPTS(['男', '女'], 'gender'),
	'ageTitle': '年齡',
	...
	'careerTitle': '從事行業',
	'careerOpts': GET_SELECT_OPTS(['經營／人資類', '行銷／企劃／專案管理類', '餐飲／旅遊／美容美髮類', '操作／技術／維修類', '營建／製圖類', '文字／傳媒工作類', '學術／教育／輔導類', '生產製造／品管／環衛類', '財會／金融專業類', '行政／總務／法務類', '客服／門市／業務／貿易類', '資訊軟體系統類', '資材／物流／運輸類', '傳播藝術／設計類', '醫療／保健服務類', '研發相關類', '軍警消／保全類', '農林漁牧相關類', '其他職類', '待業', '學生', '退休']),
	'incomeTitle': '年收入區間',
	'incomeOpts': GET_SELECT_OPTS(['20 萬以下', '21 - 30 萬', '31 - 50 萬', '51 - 80 萬', '81 - 120 萬', '121 - 150 萬', '151 萬以上']),
	...
	'charityTendencyOpts': GET_SELECT_OPTS(['捐款至對您有意義或對您在乎的人有幫助的非營利組織，例如您所就讀的母校。', '捐款至普遍大型的非營利組織，由於該組織的活動為多數人所認同，且您也容易進行捐款，例如慈濟基金會。', '捐款至富理想性的非營利組織，由於您認為他們做的事是最為重要的，例如國際特赦組織。', '捐款至與您的宗教信仰符合的非營利組織，例如教會與寺廟。', '捐款至當地的非營利組織，通常您的捐款對他們而言是一筆不小的幫助，這會讓您確切感受到您的付出。', '捐款至您所熟識的人建立的非營利組織，因個人因素而讓您想幫助他(她)所建立的組織。']),
